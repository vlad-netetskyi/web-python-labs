...
def create_app(config_name='default'):
    ...
    with app.app_context():
        ...
        app.register_blueprint(instructors_blueprint, url_prefix='/teacher')

        from .exm import instructors_api_blueprint
        app.register_blueprint(instructors_api_blueprint, url_prefix='/api/neteskyi')
